...
The following permissions are required to be assigned to the Prisma Cloud service account on the ORG level (this is required only if the Viewer role is not provided to the service account used in onboarding):
...
. Enable the “Cloud Asset API” in the project where the Prisma Cloud service account was created.
+
.. Go to the project where the Prisma Cloud service account was created
+
.. Search for Marketplace
+
.. Search for “Cloud Asset API”
+
.. Press on “Cloud Asset API”
+
.. Enable API
+
. Enable the “Cloud Identity API” in the project where the Prisma Cloud service account was created
+
.. Go to the project where the Prisma Cloud service account was created
+
.. Search for Marketplace
